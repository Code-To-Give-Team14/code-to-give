...
public class Recommendation {
    ...
    public static List<Event> findInterest(Member member) {
        OpenAIClient client = new OpenAIClientBuilder()
                .endpoint("https://openai-lio.openai.azure.com/")
                .credential(new AzureKeyCredential(System.getenv("AZURE_API_KEY")))
                .buildClient();
        ...
        List<String> event1Interests = Arrays.asList("Coding", "Hackathon");
        List<String> event2Interests = Arrays.asList("Football", "Sports", "Training");
