...
import { Form, Input, Space, Upload, DatePicker, InputNumber, Select, Button, Modal, Row, Col } from 'antd';
...
export const EventForm = (props) => {
  ...
  if (props.initialData) {
    ...
    initialData.date = [moment(initialData.startTime), moment(initialData.endTime)];
    initialData.types = initialData.types?.map((type) => ({ value: type })) || [];
    initialData.interests = initialData.interests?.map((interest) => ({ value: interest })) || [];
